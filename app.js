...
jQuery(function ($) {
    ...
    if (supportsAudio) {
        $("#btnPhotos").click(function() {
            let disp = $("#toolswrap").css("display");
            if($("#toolswrap").data("target") !== "photo" && disp === "block"){
                disp = "block";
            }else{
                disp = $("#toolswrap").css("display") === "block" ? "none" : "block";
            }
            $("#toolswrap").data("target", $("#btnPhotos").data("for"));
            $("#toolswrap").css("display", disp);
        });

        $("#btnPlaylist").click(function() {
            let disp = $("#toolswrap").css("display");
            if($("#toolswrap").data("target") !== "playlist" && disp === "block"){
                disp = "block";
            }else{
                disp = $("#toolswrap").css("display") === "block" ? "none" : "block";
            }
            $("#toolswrap").data("target", $("#btnPlaylist").data("for"));
            $("#toolswrap").css("display", disp);
        });

        $("#btnMap").click(function() {
            let disp = $("#toolswrap").css("display");
            if($("#toolswrap").data("target") !== "map" && disp === "block"){
                disp = "block";
            }else{
                disp = $("#toolswrap").css("display") === "block" ? "none" : "block";
            }
            $("#toolswrap").data("target", $("#btnMap").data("for"));
            $("#toolswrap").css("display", disp);
        });
